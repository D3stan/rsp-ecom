...
export default function PublicLayout({ children, transparent = false, currentPage }: PublicLayoutProps) {
    ...
    return (
        <div className="min-h-screen bg-white">
            ...
            {/* Main Content */}
            <main className={transparent ? '' : 'pt-0'}>
                {children}
            </main>
            ...
            <footer className="bg-black text-white py-12">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                        <div>
                            <h3 className="text-xl font-bold mb-4">{import.meta.env.VITE_APP_NAME || 'Store'}</h3>
                    ...
                    <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
                        <p>&copy; 2025 {import.meta.env.VITE_APP_NAME || 'Store'}. {t('rights_reserved')}</p>
                    </div>
                </div>
            </footer>
        </div>
